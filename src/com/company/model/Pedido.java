...
public class Pedido implements Comparable<Pedido> {
    ...
    public Pedido(int idPedido, int cliente, int idRuta, int cordX, int cordY, LocalDateTime fechaPedido,
            int tiempoLimite, Date fechaEntrega, boolean penalidad, double costoPenalidad, long duracion,
            int cantidad) {
    ...
    public int compareTo(Pedido o) {
        if (this.tiempoLimite == o.tiempoLimite) {
            if (this.cantidad == o.cantidad)
                ...
                return -1;
        } else if (this.tiempoLimite > o.tiempoLimite)
            return 1;
        else
            return -1;
    }
