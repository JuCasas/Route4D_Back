...
public class Solucion {
    ...
    public void obtenerCantidadClusters() {
        ...
        int k = (int) (0.9 * (cantidadTotal
                / (cantVehiculos1 * 25 + cantVehiculos2 * 15 + cantVehiculos3 * 10 + cantVehiculos4 * 5)));
        if (k > 10)
            k = 10;
        if (k < 3)
            k = 3;
    ...
    public List<Cluster> inicializarClusters(List<Vehicle> vehiculos) {
        ...
        for (Vehicle vehiculo : vehiculos) {
            ...
            cluster.setPedidos(new PriorityQueue<Pedido>(500, (i, j) -> {
    ...
    public String generarRutas() {
        ...
        System.out.println(
                "Tiempo de ejecución del algortimo: " + (tiempo2.getSecond() - tiempo1.getSecond()) + " segundos");
    ...
    public void obtenerRutas() {
        ...
        for (Cluster cluster : listaClusters) {
            ...
            if (cluster.getPrimerPedido() != null) {
                ...
                System.out.println(
                        "x:  " + pedido.getCordX() + "   y: " + pedido.getCordY() + "   z: " + pedido.getTiempoLimite()
                ...
                int tiempoEnLlegar = (tamanoFin - tamanoIni - 1) * 60
                        / ((int) Math.round(cluster.getVehiculo().getVelocidad()));
...
//        }
        ...
        for (int i = listaRutas.size() - 1; i >= 0; i--) {
            if (listaRutas.get(i).getVehiculo() == null)
                listaRutas.remove(i);
            else {
